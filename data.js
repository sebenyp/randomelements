...
function init() {
    ...
    for (var i = 0; i < table.length; i += 5) {
        ...
        element.style.backgroundColor = 'rgba(0,127,127,0.4)'; //' + (Math.random() * 0.5 + 0.25) + '
...
function ShowChosenPeriodicElement() {
    switch (status) {
        case "1":
            var extra = [];
            ...
            extra[data].position.x = dd1 * camera.position.x;
            extra[data].position.y = dd1 * camera.position.y;
            extra[data].position.z = dd1 * camera.position.z;

            extra[data].rotation.x = camera.rotation.x;
            extra[data].rotation.y = camera.rotation.y;
            extra[data].rotation.z = camera.rotation.z;

            transform(extra, animationDuration);
